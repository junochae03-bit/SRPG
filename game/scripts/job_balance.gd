...
const ROLES={
	...
	"sniper":["저격 · 긴 사거리 / 정밀 사격","안전한 거리를 유지하고 관통 사격을 집중합니다.",1.15,1.1],
	"hunter":["사냥 · 출혈 / 덫과 동료","사냥개와 덫으로 적을 붙잡고 지속 피해를 누적합니다.",.85,.85],
	"explorer":["기동 · 이동 / 군중 제어","이동과 제어기를 이어서 유리한 위치를 잡습니다.",1.0,1.1],
	"thief":["교란 · 표식 / 약점 노출","표식으로 접근하고 약화 효과를 쌓아 빈틈을 노립니다.",.7,.75],
	"reaper":["사슬 · 접근 / 즉결 강공격","사슬을 적중시켜 긴 차지를 즉시 발동합니다.",1.15,1.15],
	"gambler":["승부 · 카드 / 정산","52장 덱을 관리하고 높은 패에서 정산합니다.",1.0,1.1],
