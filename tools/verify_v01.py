...
run('dungeon_vision')
run('enemy_awareness')
run('combat_information')
run('combat_information_visual',graphics=True)
run('telegraph_priority')
run('telegraph_priority_visual',graphics=True)
run('enemy_tactics')
run('enemy_support')
run('encounter_roles')
run('enemy_support_visual',graphics=True)
run('enemy_defense')
run('enemy_defense_solo')
run('skill_conditions')
run('skill_conditions_visual',graphics=True)
run('enemy_defense_visual',graphics=True)
run('dungeon_exploration_routes')
run('actor_visibility')
run('actor_visibility_visual',graphics=True)
run('monster_scale')
run('monster_scale_visual',graphics=True)
run('cave_remains')
run('cave_remains_visual',graphics=True)
run('exploration_cues')
run('exploration_cues_visual',graphics=True)
run('exploration_cues_journey_visual',graphics=True)
run('dungeon_vision_visual',graphics=True)
run('sprite_frame_regions',graphics=True)
run('coop_rules')
run('combat_lifecycle')
run('exploration_rooms')
run('exploration_challenge')
run('hidden_rooms')
run('exploration_events')
run('exploration_events_visual',graphics=True)
run('exploration_shortcuts')
run('exploration_shortcuts_visual',graphics=True)
run('build_presets')
...
run('research_journey_visual',graphics=True)
run('guild_progression')
run('guild_progression_visual',graphics=True)
run('expedition_risk')
run('expedition_risk_visual',graphics=True)
run('expedition_environment')
run('expedition_environment_visual',graphics=True)
run('expedition_goals')
run('expedition_goals_visual',graphics=True)
run('expedition_journal',graphics=True)
run('hud_tabs',graphics=True)
run('consumables')
run('tactical_tools')
run('tactical_tools_visual',graphics=True)
...
run('exploration_object_art_v06')
run('agent_art_integration_visual',graphics=True)
